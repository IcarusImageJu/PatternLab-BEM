...
gulp.task("pl-sass", function() {
  return gulp
    .src(path.resolve(paths().source.css, "scss/*.scss"))
    .pipe(
      sass({
        sourcemaps: true,
...
gulp.task("pl-copy:img", function() {
  return gulp
    ...
    .pipe(imagemin())
    .pipe(cleanDest(resolvePath(paths().public.images)))
    .pipe(gulp.dest(resolvePath(paths().public.images)))
    .pipe(cleanDest(resolvePath(paths().public.nextImages)))
    .pipe(gulp.dest(resolvePath(paths().public.nextImages)));
});
...
gulp.task("pl-copy:font", function() {
  return gulp
    ...
    .pipe(gulp.dest(resolvePath(paths().public.nextFonts)));
});
...
gulp.task("pl-copy:css", function() {
  return (
    gulp
      ...
      .pipe(gulp.dest(resolvePath(paths().public.nextCss)))
      // .pipe(gulp.dest(resolvePath(paths().public.angularCss)))
...
function watch() {
  ...
  gulp
    .watch(patternWatches, { awaitWriteFinish: true })
